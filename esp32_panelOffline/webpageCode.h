...
// Your GitHub Personal Access Token (Keep this private!)
const char* github_pat = "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";
...
<body>
    ...
    <script>
        ...
        updateValues();
        setInterval(updateValues, 2000); // Update every 3 seconds
